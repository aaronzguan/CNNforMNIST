...
class Config:
    ...
    log_path = "/Users/apple/Documents/PyCharmProjects/CNNforMNIST2.0/log/log.txt"
...
def run():
    ...
    for i in range(config.epoch_num):
        ...
        if i % config.print_interval == 0:
            ...
            log.flush()
            result_summary = session.run(summary_merge, feed_dict={x: batch[0], y_: batch[1], keep_prob: 0.5})
